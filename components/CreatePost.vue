<template>
    <div id="CreatePost" class="fixed z-50 bottom-0 h-full w-full overflow-hidden">
        ...
        <div class="bg-black h-full w-full text-white overflow-auto">
            <div class="flex items-center justify-start py-4 max-w-[500px] 
            mx-auto border-b border-b-gray-700">
                ...
                <div class="py-2 w-full">
                    <div class="flex items-center">
                        <div class="flex items-center text-white">
                            ...
                            <div class="ml-2 font-semibold text-[18px]">Ernesto Maria</div>
                        </div>
                    </div>
                    <div class="relative flex items-center w-full">
                        ...
                        <div class="bg-black rounded-lg w-[calc(100%-50px)] text font-light">
                            <div class="pt-2 text-gray-300 bg-black w-full">
                                <textarea v-model="text" style="resize: none;" id="textarea" placeholder="Start a thread..."
                            ...
                            <div class="w-full">
                                <div class="flex flex-col gap-2 py-1">
                                    ...
                                    <label>
                                        ...
                                        class="cursor-pointer" color="#ffffff" size="25"/>
                                        <input 
                                        ref="file"
                                        type="file"
                                        id="fileInput"
